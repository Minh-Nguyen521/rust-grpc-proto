...
pub struct MarketsRequest {
    ...
    pub market_statuses: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct StreamTradesV2Request {
    /// MarketId of the market's orderbook we want to fetch
    #[prost(string, tag="1")]
    pub market_id: ::prost::alloc::string::String,
    /// Filter by execution side of the trade
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct StreamTradesV2Response {
    /// New spot market trade
    #[prost(message, optional, tag="1")]
    pub trade: ::core::option::Option<SpotTrade>,
    /// Executed trades update type
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct AtomicSwapHistoryRequest {
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct AtomicSwapHistoryResponse {
    /// Paging indicates total number of records with this filter
    #[prost(message, optional, tag="1")]
    pub paging: ::core::option::Option<Paging>,
    /// swap data
    #[prost(message, repeated, tag="2")]
    pub data: ::prost::alloc::vec::Vec<AtomicSwap>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct AtomicSwap {
    ...
    #[prost(string, tag="11")]
    pub refund_amount: ::prost::alloc::string::String,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Coin {

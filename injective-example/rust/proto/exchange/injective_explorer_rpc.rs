...
pub struct TxDetailData {
    ...
    #[prost(sint64, repeated, tag="22")]
    pub claim_ids: ::prost::alloc::vec::Vec<i64>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GasFee {
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetContractTxsV2Request {
    /// Address of contract
    #[prost(string, tag="1")]
    pub address: ::prost::alloc::string::String,
    /// Height of the block
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetContractTxsV2Response {
...
pub struct GetBlocksV2Response {
    #[prost(message, optional, tag="1")]
    pub paging: ::core::option::Option<Cursor>,
    #[prost(message, repeated, tag="2")]
    pub data: ::prost::alloc::vec::Vec<BlockInfo>,
}
...
pub struct TxData {
    ...
    pub tx_msg_types: ::prost::alloc::vec::Vec<u8>,
    /// transaction event logs
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetBankTransfersRequest {
    ...
    /// recipient
    #[prost(bool, tag="3")]
    pub is_community_pool_related: bool,
    #[prost(sint32, tag="4")]
    pub limit: i32,
    #[prost(uint64, tag="5")]
    pub skip: u64,
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetBankTransfersResponse {
    #[prost(message, optional, tag="1")]
    pub paging: ::core::option::Option<Paging>,
    #[prost(message, repeated, tag="2")]
    pub data: ::prost::alloc::vec::Vec<BankTransfer>,
}
...
pub struct BankTransfer {
    ...
    /// Amounts transferred
    #[prost(message, repeated, tag="3")]
    pub amounts: ::prost::alloc::vec::Vec<Coin>,
    #[prost(uint64, tag="4")]
    pub block_number: u64,
    #[prost(string, tag="5")]
    pub block_timestamp: ::prost::alloc::string::String,
